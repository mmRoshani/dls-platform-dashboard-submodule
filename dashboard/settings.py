...
SECRET_KEY = env("DASHBOARD_SECRET_KEY")
...
DATABASES = {
    'default': {
        ...
        'NAME': env("DASHBOARD_POSTGRES_DB_NAME"),
        'USER': env("DASHBOARD_POSTGRES_DB_USER"),
        'PASSWORD': env("DASHBOARD_POSTGRES_DB_PASSWORD"),
        'HOST': env("DASHBOARD_POSTGRES_DB_HOST"),
        'PORT': env("DASHBOARD_POSTGRES_DB_PORT"),
    }
}
